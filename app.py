        ...
        if len(data_array) == 5:
            ...
            if first_data in ["computer science", "Sport"]:
                ...
                if result:
                    ...
                    return render_template("bycarac2.html",route_name=route_name, data_array_length=4, names=names, department=department, major=major, group_id=group_id)
                else:
                ...
                if result:
                    names = [row[0] for row in result] 
                    return render_template("bycarac2.html",route_name=route_name, data_array_length=4, names=names, department=department, major=major)
                else:
                    return render_template("bycarac2failure.html")
                ...
                if result:
                    ...
                    return render_template("bycarac2.html",route_name=route_name, data_array_length=4, names=names, department=department)
                else:
                    return render_template("bycarac2failure.html")
            ...
            if result and result[0] == department and result[1] == major  :
                return render_template("byname2.html",data_array_length = 3, name=name, department=department, major=major)
            else:
            ...
            if result and result[0] == department  :
                return render_template("byname2.html",data_array_length = 2, name=name, department=department)
            else:
            ...
            if result:
                ...
                return render_template("byname2.html",data_array_length= 1, name=name, department=department, major=major, group_id=group_id, number=number, image=image)
